...
public class AllInterface {
     ...
     */
    //最新
    public static final String LATEST_URL = "http://app.api.autohome.com.cn/autov4.8.8/news/newslist-pm1-c0-nt0-p1-s30-l0.json";//最新
    //快报
    ...
    //原创视频
    public static final String ORIGINAL_VIDEO_URL = "http://app.api.autohome.com.cn/autov4.8.8/news/videolist-pm1-vt8-s30-lastid0.json";//原创视频..暂时无法解析
    //说客
     ...
     */
    //全部
    public static final String FOURM_URL = "http://app.api.autohome.com.cn/autov4.8.8/club/jingxuantopic-pm1-c0-p1-s30.json";//全部
    //媳妇当车模
     ...
     */
    //热帖
    public static final String TOP_POSTS_URL = "http://club.app.autohome.com.cn/club_v5.6.0/club/shotfoumlist-pm1-p1-s50.json";//热帖
    /**
     * 第二页 论坛 URL
     */
    //地区论坛
    public static final String REGION_BBS_URL = "http://club.app.autohome.com.cn/club_v5.6.0/club/clubsarea-pm2-st0.json";//地区论坛
    //主题论坛
    public static final String THEME_BBS_URL =
            "http://club.app.autohome.com.cn/club_v5.6.0/club/clubstheme-pm2-st635911592805318770.json";//主题论坛

    /**
     * 第三页 找车
     */
    //热门品牌
    public static final String HOT_BRAND_URL = "http://cars.app.autohome.com.cn/dealer_v5.7.0/dealer/hotbrands-pm2.json";//热门品牌
    //所有品牌
    public static final String ALL_BRAND_URL = "http://cars.app.autohome.com.cn/cars_v5.7.0/cars/brands-pm2-ts635966571635589297.json";//所有品牌
    //筛选
    public static final String SCREENING_URL = "http://cars.app.autohome.com.cn/cars_v5.7.0/cars/gethotseries-a2-pm2-v5.9.0-p1-s20.json";//筛选
    //降价
    public static final String DEPRECIATE_URL = "http://cars.app.autohome.com.cn/dealer_v5.7.0/dealer/pdspecs-pm2-pi210000-c210200-o0-b0-ss0-sp0-p1-s20-l0-minp0-maxp0-lon121.55099-lat38.889673.json";//降价
    //降价-品牌
    public static final String DEPRECIATE_BRAND_URL = "http://cars.app.autohome.com.cn/dealer_v5.7.0/cars/brandsdealer-pm2-ts0.json";//降价-品牌
    //找二手车
    public static final String WEB_URL = "http://m.che168.com/dalian/list/?sourcename=mainapp&amp;pvareaid=102254"; //找二手车

    /**
     * 第四页 发现
     */
    //轮播图
    public static final String DISCOVER_ROTATE_IMG_URL = "http://app.api.autohome.com.cn/autov5.0.0/mobile/appadvert-a2-pm1-v5.0.1-sid2-pid340000-cid0-lat0.000000-lng0.000000.json";//轮播图
    //活动
    public static final String DISCOVER_TWO_URL = "http://mobilenc.app.autohome.com.cn/discover_v5.8.0/mobile/functionlist-a2-pm2-v5.9.0-pid210000-cid210200.json";//活动
    //剩下全部
    public static final String DISCOVER_BODY_URL = "http://mobilenc.app.autohome.com.cn/discover_v5.8.0/mall/intelligentrecommend.ashx?a=2&pm=2&v=5.8.5&uid=0&deviceid=99000628573771&gps=38.889659,121.551063&cityid=210200&pid=210000&pageindex=1&pagesize=20&hid=";//剩下全部
     ...
     */
    //我的优惠券
    public static final String MY_COUPONS_URL = "http://mobilenc.app.autohome.com.cn/discover_v5.6.0/mobile/getcouponcount.ashx?a=2&pm=2&v=5.9.0&uid=27864502";//我的优惠券
    //来自的城市
    public static final String MY_CITY_URL = "http://comm.app.autohome.com.cn/news/province-pm2-ts0.json";//来自的城市
